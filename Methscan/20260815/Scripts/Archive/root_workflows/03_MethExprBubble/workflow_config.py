...
PROJECT_ROOT = Path(
    os.environ.get("PROMOTER_DMR_PROJECT_ROOT", "/share/home/rzli/METHSCAN/03_MethExprBubble")
)
RESULT_ROOT = Path(os.environ.get("PROMOTER_DMR_RESULT_ROOT", PROJECT_ROOT / "results"))
