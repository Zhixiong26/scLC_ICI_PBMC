...
OUT = IN_DIR / "promoter_DMR_to_gene_q001_2kb_2kb.tsv"
...
for f in sorted(IN_DIR.glob("*_promoter_DMRs_q001_2kb_2kb.full.tsv")):
    name = f.name.replace("_promoter_DMRs_q001_2kb_2kb.full.tsv", "")
