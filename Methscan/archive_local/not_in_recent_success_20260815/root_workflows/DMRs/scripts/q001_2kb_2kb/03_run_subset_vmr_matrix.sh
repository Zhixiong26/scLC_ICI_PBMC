...
BASE="/share/home/rzli/METHSCAN/Meth_diff/DMR_clean_200k_q001"
...
python "${SCRIPT_DIR}/02_subset_vmr_matrix.py" \
  --input-dir "${INPUT_DIR}" \
  --region-list "${MAP_DIR}/clean_cell_type_DMR_q001_overlap_All_VMR_regions.txt" \
  --output-dir "${BASE}/VMR_matrix_all_clean_cell_type_DMR_q001"
