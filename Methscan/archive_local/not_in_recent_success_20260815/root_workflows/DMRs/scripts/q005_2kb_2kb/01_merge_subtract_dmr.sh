...
echo "[INFO] Filter cell-type DMRs by q < 0.05 and merge"
...
echo "[INFO] Filter sample-component DMRs by q < 0.05 and merge"
...
echo "[INFO] Remove q<0.05 sample-component DMRs from q<0.05 cell-type DMRs"
...
echo "[INFO] Map q<0.05 clean DMRs back to All VMR matrix regions"
...
echo "[INFO] Intersect top5/top2 VMRs with q<0.05 clean DMRs"
