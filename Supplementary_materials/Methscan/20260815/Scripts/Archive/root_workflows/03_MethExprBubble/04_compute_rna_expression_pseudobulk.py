#!/usr/bin/env python3
"""Compute matched sample x cell-type mean log1p(CPM) for promoter-DMR genes."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=RESULT_ROOT / "04_RNA_pseudobulk")
