...
INFILE = Path(
    "/share/home/rzli/METHSCAN/Meth_diff/DMR_disease_200k_q001/"
    "promoter_annotation/per_cell_type_promoter_DMRs_2kb_2kb/"
    "promoter_DMR_to_gene_q001_2kb_2kb.tsv"
)

OUT_DIR = INFILE.parent

OUT_PC = OUT_DIR / "promoter_DMR_to_protein_coding_gene_q001_2kb_2kb.tsv"
OUT_CANDIDATE = OUT_DIR / "protein_coding_promoter_DMR_candidate_genes_q001_2kb_2kb.tsv"
